...
class _SelectLocationMapPageState extends State<SelectLocationMapPage> {
  ...
  double _rangeRadius = 50.0; // Default radius in meters
  ...
  void initState() {
    ...
    if (widget.initialLatitude != null && widget.initialLongitude != null) {
      ...
      if (widget.initialRadius != null) {
        _rangeRadius = widget.initialRadius!;
      }
    }
  }
  ...
  void _onMapTap(LatLng point) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Location selected. Adjust the range if needed.'),
  ...
  List<LatLng> _generateCirclePoints(LatLng center, double radiusInMeters) {
    ...
    for (int i = 0; i <= numberOfPoints; i++) {
      ...
      final point = distance.offset(center, radiusInMeters, bearing);
      points.add(point);
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Select Lost Location'),
        ...
        children: [
          FlutterMap(
            ...
            children: [
              ...
              // Circle for the selected location range
              if (_selectedLocation != null)
                PolygonLayer(
                  polygons: [
                    Polygon(
                      points: _generateCirclePoints(_selectedLocation!, _rangeRadius),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            'Tap on the map to select where you lost your item',
                            style: TextStyle(
                              fontSize: 14,
          ...
          // Range Adjustment Card at the bottom
          if (_selectedLocation != null)
            Positioned(
              bottom: 16,
              left: 16,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Adjust the circle to indicate the approximate area where you lost your item',
                        style: TextStyle(
                          fontSize: 12,
                          color: Colors.grey.shade600,
                        ),
