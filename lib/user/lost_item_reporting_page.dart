...
class _LostItemReportingPageState extends State<LostItemReportingPage> {
    ...
    final bool? confirmed = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Are you sure you want to submit this lost item report?'),
      ...
      if (_compressedImageBytes != null && allowedForImage < MIN_IMAGE_BYTES) {
        throw Exception(
            'Document size exceeded. The text fields are too large to include an image. '
                'Please reduce description length or submit without a photo.'
        );
      }
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  _lostDateTime != null
                                      ? DateFormat('yyyy-MM-dd HH:mm').format(_lostDateTime!)
